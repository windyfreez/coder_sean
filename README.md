...
## 前言
- 本人是一个西安电子科技大学的计算机科学与技术专业的学生，本项目为本人 **AI 应用开发**方向的个人实践项目，后端服务、知识库流水线、个人 Skill 机制与前端页面均由本人在学习过程中独立设计与实现。
...
本人是一个**西安电子科技大学的计算机科学与技术专业本科在读学生**，自 **2025 年初**开始系统学习 Java 后端开发，目前正在求职 **Java 后端 + AI 应用开发**方向的实习岗位，毕业时间为 **2028 年夏季**。
